...
// Thu Aug 11 15:46:27 2016 by ROOT version 5.34/34
// from TTree vmm2/vmm2
// found on file: run_9161.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<vector<int> > *ARTTimeStamp;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run_9161.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run_9161.root");
      }
