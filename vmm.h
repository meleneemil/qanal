...
// Sun Apr  2 16:43:36 2017 by ROOT version 5.34/36
// from TTree vmm/vmm
// found on file: run_2670_2MDT24_03_2017_trigatpeak.root
//////////////////////////////////////////////////////////
...
//    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("vmm");
//    if (!f || !f->IsOpen()) {
//        f = new TFile("filename required as input");
